...
INSERT INTO empresas   (razao_social, nome_fantasia, cnpj, inscricao_estadual, data_abertura,   telefone, email, capital_social, natureza_juridica, situacao_cadastral,   data_situacao, socios_receita, ativa)   VALUES (?,?,?,?,?,?,?,?,?,?,?,?,1),
[
razao_social,
nome_fantasia,
cnpjNum,
...
const [ins] = await conn.query(
INSERT INTO pessoas (nome, cpf, data_nascimento, telefone, email)   VALUES (?,?,?,?,?),
...
await conn.query(
INSERT IGNORE INTO usuarios_perfis (empresa_id, usuario_id, perfil_id)   VALUES (?,?,?),
[empresaId, usuarioId, perfilId]
);
await conn.query(
INSERT IGNORE INTO empresas_usuarios (empresa_id, usuario_id, perfil_principal, ativo)   VALUES (?,?,?,1),
...
await conn.query(
INSERT IGNORE INTO usuarios_pessoas (empresa_id, usuario_id, pessoa_id)   VALUES (?,?,?),
